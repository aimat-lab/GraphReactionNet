...
class MPNN_GlobalReadout(nn.Module):
    """
    ...
    def __init__(self, in_n, hidden_state_size, message_size, n_layers, l_target, config, type='regression'):
        super(MPNN_GlobalReadout, self).__init__()
