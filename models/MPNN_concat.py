...
from models.layers import MessageFunction
from models.layers import UpdateFunction
from models.layers import ReadoutFunction
...
class MPNN_concat(nn.Module):
    ...
    def __init__(self, in_n, hidden_state_size, message_size, n_layers, l_target, readout, type='regression'):
        super(MPNN_concat, self).__init__()
		# readout two type global node, all nodess
        # Define message
        ...
        # Define Readout
        self.r = ReadoutFunction(readout,
    ...
    def forward(self, g, h_in, e):
        ...
        for t in range(0, self.n_layers):
            ...
            # TODO how it works and change MPNN
