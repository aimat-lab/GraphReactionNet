...
def main_worker(gpu, ngpus_per_node, args):
    ...
    checkpoint_dir = train(model, train_loader, valid_loader, criterion_mse, evaluation, args, optimizer,
                           epochs=args.epochs, lr=args.lr, device=args.gpu)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datasetPath', default='data/data/data-b3d25f30-aebb-4e5d-bebd-71b1bf999c02.pickle',
                        help='dataset path')
